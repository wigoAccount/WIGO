...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        public float GetSafeAreaUpperPadding()
        {
            Rect safeArea = GetSafeArea();
            var canvasSize = ServiceLocator.Get<UIManager>().GetCanvasSize();
            var upperPadding = (Screen.height - (safeArea.y + safeArea.height)) / Screen.height;
            var deltaY = canvasSize.y * upperPadding;

            return deltaY;
        }

        public float GetSafeAreaBottomPadding()
        {
            Rect safeArea = GetSafeArea();
            var canvasSize = ServiceLocator.Get<UIManager>().GetCanvasSize();
            var bottomPadding = safeArea.y / Screen.height;
            var deltaY = canvasSize.y * bottomPadding;
